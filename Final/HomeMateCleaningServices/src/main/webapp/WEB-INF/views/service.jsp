                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <h3>Bedroom Cleaning</h3>
                                 <p>
                                    The bedroom is your comfort zone and we understand that, We assure deep end to 
                                    end cleaning which starts with the furniture and finishes down to cleaning electrical
                                    appliances in the bedroom.
                                </p>
                                <a class="btn" href="/customerlogin">Book Now</a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <p>
                                  Our special glass treatment brings back the  
               					  original polished look, finished with a special coat which ensures the freshness lasts long and remains 
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <h3>Room Cleaning</h3>
                                <p>
                                    Tiles on the floors and bathroom walls have the tendency to deteriorate overtime as a result of exposure to
                                    enviromental pollutants and thus being difficult to clean up. We return tiles to their former color and shine with
                                    extensive care tools.
                                </p>
                                <a class="btn" href="/customerlogin">Book Now</a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                               ...
                               <p>
                                    Bathrooms and Toilets require a different approach to clean thouroughly as years of build up and lack of cleaning 
                                    leads to deterioration of sanitary infrastructure and lack of hygiene. HomeMate provides complete cleaning and sanitation
                                </p>
                                <a class="btn" href="/customerlogin">Book Now</a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <p>
                                    The kitchen is the heart of the home and keeping that in mind
                                    we revamp your kitchen and recondition 
                                    all the utensils so good, you'll think its a cooking show kitchen!
                                </p>
                                <a class="btn" href="/customerlogin">Book Now</a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <p>
                                    Who says water tank cleaning can only be done once every few years? We give complete water tank cleaning
                                    including flushing it free of fungus and moss that generally accumlates.
                                </p>
                                <a class="btn" href="/customerlogin">Book Now</a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <h3>Pest Control</h3>
                                <p>
                                    Pest control service at your disposal just a click away, if you have pest issues inside or outside
                                    the house, leave it to us.<br> 
                                    Assured satisfaction within a day of service.
