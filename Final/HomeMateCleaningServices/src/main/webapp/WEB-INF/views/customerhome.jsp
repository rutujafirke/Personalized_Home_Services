                                        ...
                                        <tr>
                                            ...
                                            <th>City</th>
                                             ...
                                             <tr>
                                                 ...
                                                 <td><p><%=customer.getCustomerFirstname()%><%=customer.getCustomerLastname()%> </p></td>
                                                 <td><p> ${customer.getCustomerMobile()}</p></td>
                                                 <td><p>${customer.getCustomerEmail()}</p></td>
                                                 <td><p>${customer.getCustomerAddress()}</p></td>
                                                 <td><p>${customer.getCustomerCity()}</p></td>
