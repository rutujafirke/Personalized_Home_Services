...
public class ServicesTbl implements Serializable {
	...
	public ServicesTbl( int serviceCost, String serviceDiscount, String serviceTimeHrs,
			String serviceType, VendorTbl vendorTbl) {
		super();
	...
	public ServicesTbl(int serviceId, int serviceCost, String serviceDiscount, String serviceTimeHrs,
			String serviceType,VendorTbl vendorTbl) {
		super();
		this.serviceId = serviceId;
		this.serviceCost = serviceCost;
