...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>HomeMate - Contact Us</title>
                    ...
                    <div class="header-top row align-items-center">
                        ...
                        <div class="col-lg-9">
                            <div class="topbar">
                                ...
                                <div class="topbar-col">
                                    <a href="mailto:info@example.com"><i class="fa fa-envelope"></i>support@homemate.com</a>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a class="card-link collapsed" data-toggle="collapse" href="#collapseOne" aria-expanded="true">
                                                <span>1</span> What timings are suitable to contact you guys?
                                            </a>
                                        </div>
                                        <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                            <div class="card-body">
                                                As we are currently in our expansion phase, we do not have timings exceeding working hours 
                                                9AM to 6PM but we hope to extend support to 24/7.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-header">
                                            <a class="card-link" data-toggle="collapse" href="#collapseTwo">
                                                <span>2</span> Is it possible to contact via email?
                                            </a>
                                        </div>
                                        <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                            <div class="card-body">
                                                Yes ofcourse!, mailing is one of our support systems that you can use 
