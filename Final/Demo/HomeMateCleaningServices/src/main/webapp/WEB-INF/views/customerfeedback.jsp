                    ...
                    <div class="col-lg-9 my-lg-0 my-1">
                        <div id="main-content" class="bg-white border">
                            <div class="d-flex flex-column">
                                ...
                                <hr/>
                                <table>
                                    <tbody class="table table-border" border="2">
                                        <tr>
                                            <th>Service Type</th>
                                            ...
                                            <%
                                            	List<OrderBookingTbl> list = (List<OrderBookingTbl>)request.getAttribute("delivered");
                                            	for(OrderBookingTbl book:list)
                                            	{
                                            ...
                                            %>
                                             ...
                                             <tr>
                                                 ...
                                                 <td><p><%=book.getServicesTbl().getServiceType()%></p></td>
                                                 <td><p><%=book.getBookingStatus()%></p></td>
												<td><a href="/givefeedback?id=<%=book.getBookingId()%>"
											    class="btn btn-primary btn-block" type="submit">Give Feedback</a></td>
